...
const QUIZ = [
  {
    q: "A researcher compares anxiety scores of students before and after a relaxation exercise. Which test is most appropriate if assumptions are met?",
    options: ["Independent samples t-test", "Paired samples t-test", "Chi-square test", "Pearson correlation"],
    answer: 1,
    rationale: "The same students were measured twice, so the scores are related. A paired samples t-test is appropriate."
  },
  {
    q: "A psychologist examines whether social media use category is associated with sleep quality category. Which test is most appropriate?",
    options: ["Pearson correlation", "One-way ANOVA", "Chi-square test of independence", "Paired samples t-test"],
    answer: 2,
    rationale: "Both variables are categorical, so a chi-square test of independence is appropriate."
  },
  {
    q: "A teacher compares mean motivation scores across three instructional methods. Which test is most appropriate if assumptions are met?",
    options: ["One-way ANOVA", "Mann–Whitney U", "Paired samples t-test", "Fisher's exact test"],
    answer: 0,
    rationale: "There are three independent groups and one continuous outcome, so one-way ANOVA is appropriate."
  },
  {
    q: "A researcher wants to know whether self-esteem scores are related to loneliness scores. Which test is most appropriate if both variables are scale-level and approximately normal?",
    options: ["Pearson r", "Wilcoxon signed-rank test", "Chi-square test", "Independent samples t-test"],
    answer: 0,
    rationale: "The question asks about the relationship between two continuous variables, so Pearson correlation is appropriate."
  },
  {
    q: "A clinical study has two independent groups, but the outcome is ordinal and strongly non-normal. Which test is most appropriate?",
    options: ["Independent samples t-test", "Mann–Whitney U test", "Paired samples t-test", "Repeated-measures ANOVA"],
    answer: 1,
    rationale: "For two independent groups with ordinal or clearly non-normal outcomes, Mann–Whitney U is the safer nonparametric option."
  }
];
